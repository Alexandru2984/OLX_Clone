#!/bin/bash
# Script de deploy pentru OLX Clone pe VPS cu domeniul tău
# Folosire: ./deploy.sh yourdomain.com
...
DOMAIN=$1
if [ -z "$DOMAIN" ]; then
    print_error "Te rog să specifici domeniul!"
    echo "Folosire: ./deploy.sh yourdomain.com"
    exit 1
fi

print_info "Deploying pentru domeniul: $DOMAIN"
